...
namespace EntityFactory
{
	...
	void create_player()
	{
		...
		{ gameData.playerStats.maxPoints,	//max points
			...
			gameData.playerStats.shields,	//shields
			gameData.playerStats.atkBuffHitsLeft,	//atkhits left
			gameData.playerStats.atkBuffStacks,	//atkbuff stacks left
			gameData.playerStats.atkMultiplier,	//ATK Multiplier
			gameData.playerStats.damageTakenMultiplier,	//invincibility flag
			gameData.playerStats.max_movSpd };	//movement spd
